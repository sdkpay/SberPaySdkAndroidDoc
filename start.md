...
> 
> Важно!  
> Библиотека постоянно обновляется и документация может за ней не успевать. Если каких-то транзитивных зависимостей не хватает их можно достать из .pom-файла, переданного вместе с aar
