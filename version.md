...
- Исправлена логика поля ввода номера телефона
- Добавлена возможность закрыть экран бесшовной авторизации вручную
- Убран звук при беззвучном режиме в вибро-режиме
- Исправлена логика – при бесшовке биометрия на картах не запрашивается
- Исправлен краш при включении кнопки SPay
- Исправлена ошибка оплаты бонусами
- Исправлено некорректное отображение суммы бонусов
- Исправлено некорректное отображение при смене темы в системе

### 3.2.1

- Обновление безопасности SSL-pinning 2.0
- Улучшение UX при ошибках авторизации
- Исправлена работа с куками

### 3.2.0

- Устаревший метод оплаты связками отмечен как *deprecated*
- Добавлен новый метод оплаты связками **SPayMethod.BindingPayment**

## Версия 3.1

### 3.1.3

- Исправлен плавающий краш при инициализации SDK

### 3.1.2

 - Исправлен запуск авторизации через мобильное приложение Банка, после отказа от биометрии
